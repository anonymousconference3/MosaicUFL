...
parser.add_argument('--threshold_p', type=float, default=0.95)
parser.add_argument('--this_rank', type=int, default=1)
parser.add_argument('--learners', type=str, default='1-2-3-4-5-6-7-8')
...
parser.add_argument('--exploration_decay', type=float, default=1)
...
parser.add_argument('--overcommit', type=float, default=0.7)
...
parser.add_argument('--client_numbers', type=int, default=100)
parser.add_argument('--suc', type=int, default=7)
parser.add_argument('--record_cos', type=int, default=0)
parser.add_argument('--limit_period', type=int, default=300)
parser.add_argument('--extend_loss', type=int, default=0)
...
parser.add_argument('--sample_seed', type=int, default=1234) #123 #233 #1234
...
parser.add_argument('--have_oort', type=bool, default=False)
parser.add_argument('--record_name', type=str, default='')
parser.add_argument('--cos_limit', type=float, default=0)
parser.add_argument('--change_limit',type=int,default=0)
# for text clf
...
parser.add_argument('--all_update', type=int, default=1)
parser.add_argument('--load_client', type=int, default=0)
parser.add_argument('--l_distance', type=int, default=0)
parser.add_argument('--loss_record', type=int, default=0)
parser.add_argument('--server_update', type=int, default=1)
parser.add_argument('--server_update_interval', type=int, default=1)
